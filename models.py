...
#telling flask how to connect to sql alchemy
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SQLALCHEMY_ECHO'] = True
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://localhost/flasql'
#telling sql alchemy how to connect to flask
db = SQLAlchemy(app)
...
class Post(db.Model):
    ...
    #foreign key takes a parameter that links it to which id you want to use/connect
